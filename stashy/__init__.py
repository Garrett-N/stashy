...
def connect(url, username=None, password=None, verify=True, token=None, requests_auth=None):
    ...
    """
    return Stash(url, username, password, verify=verify, token=token, requests_auth=requests_auth)
